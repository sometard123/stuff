package com.lgrey.utils
{
   ...
   public class LGMathUtil
   {
      ...
      public function LGMathUtil(param1:SingletonEnforcer#1219)
      {
         super();
         if(param1 == null)
         {
      ...
      public static function getInstance() : LGMathUtil
      {
         if(_instance == null)
         {
            _instance = new LGMathUtil(new SingletonEnforcer#1219());
         }
         return _instance;
      }
...
class SingletonEnforcer#1219
{
    
   
   function SingletonEnforcer#1219()
   {
      super();
   }
}
