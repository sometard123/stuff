package com.lgrey.utils
{
   ...
   public class LGDisplayListUtil
   {
      ...
      public function LGDisplayListUtil(param1:SingletonEnforcer#437)
      {
         super();
         if(param1 == null)
         {
      ...
      public static function getInstance() : LGDisplayListUtil
      {
         if(_instance == null)
         {
            _instance = new LGDisplayListUtil(new SingletonEnforcer#437());
         }
         return _instance;
      }
      ...
      {
         var _loc3_:Point = this.localToLocal(new Point(param1.x,param1.y),param1.parent,param2);
...
class SingletonEnforcer#437
{
    
   
   function SingletonEnforcer#437()
   {
      super();
   }
}
