...
{
   import ninjakiwi.monkeyTown.btdModule.abilities.antiBossAbilities.def.AntiBossAbilityDef;
   ...
   public class MonkeyKnowledgeTree
   {
      ...
      public function MonkeyKnowledgeTree(param1:SingletonEnforcer#588)
      {
      ...
      public static function getInstance() : MonkeyKnowledgeTree
      {
         if(instance == null)
         {
            instance = new MonkeyKnowledgeTree(new SingletonEnforcer#588());
         }
         return instance;
      }
      ...
      private function initPaths() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            new MonkeyKnowledgePath().id = _loc3_;
...
class SingletonEnforcer#588
{
    
   
   function SingletonEnforcer#588()
   {
      super();
   }
}
