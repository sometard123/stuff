package ninjakiwi.monkeyTown.btdModule.weapons
{
   ...
   public class SingleSpread extends Standard implements HasSpread
   {
      ...
      public function Spread(param1:Number) : SingleSpread
      {
         this.spread = param1;
         return this;
      }
      
      public function Range(param1:Number) : SingleSpread
      {
         range = param1;
         return this;
      }
      
      public function ReloadTime(param1:Number) : SingleSpread
      {
         reloadTime = param1;
         return this;
      }
      
      public function Power(param1:Number) : SingleSpread
      {
         power = param1;
         return this;
      }
      
      public function Projectile(param1:ProjectileDef) : SingleSpread
      {
         projectile = param1;
         return this;
      }
      
      public function Proxied(param1:Boolean) : SingleSpread
      {
         proxied = param1;
         return this;
      }
      ...
      public function Rotate(param1:Boolean) : SingleSpread
      {
         this.rotate = param1;
         return this;
      }
      
      public function IsBaseWeapon(param1:Boolean) : SingleSpread
      {
         isBaseWeapon = param1;
         return this;
      }
