package ninjakiwi.monkeyTown.btdModule.weapons
{
   ...
   public class SinkBloon extends Standard
   {
      ...
      public function SinkBloon(param1:String = null)
      {
      ...
      public function Range(param1:Number) : SinkBloon
      {
         range = param1;
         return this;
      }
      
      public function ReloadTime(param1:Number) : SinkBloon
      {
         reloadTime = param1;
         return this;
      }
      
      public function Power(param1:Number) : SinkBloon
      {
         power = param1;
         return this;
      }
      
      public function Projectile(param1:ProjectileDef) : SinkBloon
      {
         projectile = param1;
         return this;
      }
      
      public function Proxied(param1:Boolean) : SinkBloon
      {
         proxied = param1;
         return this;
      }
      ...
      public function Rotate(param1:Boolean) : SinkBloon
      {
         this.rotate = param1;
         return this;
      }
      ...
      override public function execute(param1:Tower, param2:Entity, param3:Entity, param4:Vector2 = null) : void
      {
         ...
         {
            if((param1.def.behavior.process as WhirpoolStore).canSuck(param1,_loc6_))
            {
               _loc5_ = _loc6_;
               break;
            }
         ...
         (param1.def.behavior.process as WhirpoolStore).addBloon(param1,_loc5_);
      }
   }
}
