package ninjakiwi.monkeyTown.btdModule.towers.modifiers
{
   ...
   public class AttackSpeedTemporaryModifierBoss extends TowerModifier
   {
      ...
      public function AttackSpeedTemporaryModifierBoss(param1:Tower, param2:Number, param3:Number)
      {
         super(param1);
         mustBeUnique = true;
