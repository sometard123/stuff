package ninjakiwi.monkeyTown.btdModule.towers.behavior.process
{
   ...
   public class WhirpoolStore extends BehaviorProcess
   {
      ...
      public function MaxBloons(param1:int) : WhirpoolStore
      {
      ...
      public function Damage(param1:int) : WhirpoolStore
      {
         this.damage = param1;
         return this;
      }
      ...
      public function ChipTime(param1:Number) : WhirpoolStore
      {
      ...
      override public function process(param1:Tower, param2:Number) : void
      {
         ...
         var _loc11_:int = 0;
         var _loc3_:Vector.<TrappedBloon> = WhirpoolStore.store[param1];
         if(_loc3_ == null)
         {
            return;
         }
