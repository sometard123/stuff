package ninjakiwi.monkeyTown.monkeyKnowledge
{
   ...
   public class MonkeyKnowledgeBuffData
   {
      ...
      public function MonkeyKnowledgeBuffData(param1:SingletonEnforcer#1369)
      {
      ...
      public static function getInstance() : MonkeyKnowledgeBuffData
      {
         if(instance == null)
         {
            instance = new MonkeyKnowledgeBuffData(new SingletonEnforcer#1369());
         }
         return instance;
      }
...
class SingletonEnforcer#1369
{
    
   
   function SingletonEnforcer#1369()
   {
      super();
   }
}
