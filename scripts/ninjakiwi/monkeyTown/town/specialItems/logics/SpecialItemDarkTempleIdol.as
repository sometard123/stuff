package ninjakiwi.monkeyTown.town.specialItems.logics
{
   ...
   public class SpecialItemDarkTempleIdol extends SpecialItemInBTDGame
   {
       
      
      public function SpecialItemDarkTempleIdol(param1:SpecialItemDefinition, param2:int = 0)
      {
         super(param1,param2);
      }
      ...
      {
         getTowerParam(param1,"SuperMonkey")["dark"] = true;
      }
   }
}
