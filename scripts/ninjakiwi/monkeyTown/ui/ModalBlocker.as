package ninjakiwi.monkeyTown.ui
{
   ...
   public class ModalBlocker extends MovieClip
   {
      ...
      private static var instance:ModalBlocker;
      ...
      public function reveal(param1:Object, param2:DisplayObjectContainer, param3:Number = 0.5) : void
      {
         ...
         var _loc5_:ModalBlockerClip = getClip();
         var _loc6_:ModalWindowElement = new ModalWindowElement(param1,param2,_loc5_);
         _modalList.push(_loc6_);
         _loc4_ = 0;
         while(_loc4_ < _modalList.length)
         {
            if(_modalList[_loc4_].key != param1)
            {
               if(_modalList[_loc4_].clip.visible == true)
               {
                  _modalList[_loc4_].clip.visible = false;
                  _loc6_.backupClip = _modalList[_loc4_].clip;
                  break;
               }
            }
            _loc4_++;
         ...
         TweenLite.to(_loc5_,param3,{"alpha":0.4});
